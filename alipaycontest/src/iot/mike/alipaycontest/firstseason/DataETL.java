...
public class DataETL {
    ...
    public static void main(String[] args) {
        ...
        for (Integer userid : users) {
            LinkedList<DataItem> userItems = new LinkedList<>();
            for (DataItem dataItem : DataHolder.getDataByUserID(userid)) {
                ...
                switch (dataItem.getType()) {
                    case 0: {// click
                        userItem.setPreference(userItem.getPreference() + 1);
                        break;
                    }
                    case 1: {// buy
                    ...
                    case 2: {// mark
                        userItem.setPreference(userItem.getPreference() + 5);
                        break;
                    }
            ...
            for (DataItem dataItem : userItems) {
                ...
                builder.append(dataItem.getUserid() + "," + dataItem.getBrandid() + "," + dataItem.getPreference() + "\n");
            }
